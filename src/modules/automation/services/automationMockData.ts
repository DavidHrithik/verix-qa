...
export const initialAutomationScripts: AutomationScriptExtended[] = [
  {
    ...
    stabilityScore: 62,
    runHistory: [
      { runAt: '2026-08-19T08:00:00Z', passed: true },
      { runAt: '2026-08-20T08:00:00Z', passed: true },
      { runAt: '2026-08-21T08:00:00Z', passed: false },
      { runAt: '2026-08-22T08:00:00Z', passed: true },
      { runAt: '2026-08-23T08:00:00Z', passed: false },
      { runAt: '2026-08-24T08:00:00Z', passed: false },
      { runAt: '2026-08-25T08:00:00Z', passed: true },
      { runAt: '2026-08-26T08:00:00Z', passed: false },
      { runAt: '2026-08-27T08:00:00Z', passed: true },
      { runAt: '2026-08-28T08:00:00Z', passed: false },
      { runAt: '2026-08-29T08:00:00Z', passed: true },
      { runAt: '2026-08-30T09:14:00Z', passed: true },
    ],
...
Feature: CLOUD-204 - Workspace Admin Data Export & PII Masking Governance Policy
  ...
  },
  {
    ...
    stabilityScore: 96,
    runHistory: [
      { runAt: '2026-08-17T09:00:00Z', passed: true },
      { runAt: '2026-08-18T09:00:00Z', passed: true },
      { runAt: '2026-08-19T09:00:00Z', passed: true },
      { runAt: '2026-08-20T09:00:00Z', passed: true },
      { runAt: '2026-08-21T09:00:00Z', passed: true },
      { runAt: '2026-08-22T09:00:00Z', passed: true },
      { runAt: '2026-08-23T09:00:00Z', passed: false },
      { runAt: '2026-08-24T09:00:00Z', passed: true },
      { runAt: '2026-08-25T09:00:00Z', passed: true },
      { runAt: '2026-08-26T09:00:00Z', passed: true },
      { runAt: '2026-08-27T09:00:00Z', passed: true },
      { runAt: '2026-08-28T09:00:00Z', passed: true },
      { runAt: '2026-08-29T09:00:00Z', passed: true },
      { runAt: '2026-08-30T09:12:00Z', passed: true },
    ],
...
Feature: DBANK-104 - High-Value Wire Transfer with Multi-Factor Authentication
  ...
  },
  {
    ...
    stabilityScore: 79,
    runHistory: [
      { runAt: '2026-08-15T08:00:00Z', passed: true },
      { runAt: '2026-08-16T08:00:00Z', passed: true },
      { runAt: '2026-08-17T08:00:00Z', passed: false },
      { runAt: '2026-08-18T08:00:00Z', passed: false },
      { runAt: '2026-08-19T08:00:00Z', passed: false },
      { runAt: '2026-08-20T08:00:00Z', passed: true },
      { runAt: '2026-08-21T08:00:00Z', passed: true },
      { runAt: '2026-08-22T08:00:00Z', passed: true },
      { runAt: '2026-08-23T08:00:00Z', passed: true },
      { runAt: '2026-08-24T08:00:00Z', passed: true },
      { runAt: '2026-08-25T08:00:00Z', passed: true },
      { runAt: '2026-08-26T08:00:00Z', passed: true },
      { runAt: '2026-08-27T08:00:00Z', passed: true },
      { runAt: '2026-08-28T08:00:00Z', passed: true },
      { runAt: '2026-08-29T08:00:00Z', passed: true },
      { runAt: '2026-08-30T08:45:00Z', passed: true },
    ],
...
Feature: DBANK-108 - Virtual Card Management and Instant Freeze
  ...
  },
  {
    ...
    stabilityScore: 100,
    runHistory: [
      { runAt: '2026-08-24T10:00:00Z', passed: true },
      { runAt: '2026-08-25T10:00:00Z', passed: true },
      { runAt: '2026-08-26T10:00:00Z', passed: true },
      { runAt: '2026-08-27T10:00:00Z', passed: true },
      { runAt: '2026-08-28T10:00:00Z', passed: true },
      { runAt: '2026-08-29T10:00:00Z', passed: true },
      { runAt: '2026-08-30T10:00:00Z', passed: true },
      { runAt: '2026-08-31T12:00:00Z', passed: true },
    ],
